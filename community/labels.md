...
based on the [labels.yaml](https://github.com/thoth-station/core/blob/main/labels.yaml) that it uses to
...
- Open a PR, _with a single commit_, that:
  - updates [labels.yaml](https://github.com/thoth-station/core/blob/main/labels.yaml) with the new label(s)
...
| <a id="sig/observability" href="#sig/observability">`sig/observability`</a> | Categorizes an issue or PR as relevant to SIG Observability <br><br> This was previously `sig/indicators`, `sig/slo`, | anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
| <a id="sig/stack-guidance" href="#sig/stack-guidance">`sig/stack-guidance`</a> | Categorizes an issue or PR as relevant to SIG Stack Guidance. <br><br> This was previously `area/stack-guidance`, `sig/investigator`, `sig/knowledge-graph`, `sig/solvers`, `sig/adviser`, | anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
| <a id="sig/user-experience" href="#sig/user-experience">`sig/user-experience`</a> | Issues or PRs related to the User Experience of our Services, Tools, and Libraries. <br><br> This was previously `sig/docs`, | human |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
...
| Name | Description | Added By | Prow Plugin |
| ---- | ----------- | -------- | --- |
| <a id="good first issue" href="#good first issue">`good first issue`</a> | Denotes an issue ready for a new contributor, according to the "help wanted" guidelines. <br><br> This was previously `good-first-issue`, | anyone |  [help](https://git.k8s.io/test-infra/prow/plugins/help) |
