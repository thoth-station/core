...
issue](#good-first-issue) to identify issues that have been specially refined
...
- **Clear Task**
  ...
  API / CLI behavior is decided and included in the issue, for example: _"The
  new command syntax is `thamos advise [--orphan] [--timeout 5m]`"_, with
...
community can continue to grow and maintain the kind, inclusive community that
we all enjoy today.
...
- Offer advice such as _"One way to reproduce this in a cluster is to do X and
  then you can use ..."_, or _"Did you know that you can
  use ... to test this easier?"_.
...
- Encourage new contributors to seek help on the appropriate channels,
